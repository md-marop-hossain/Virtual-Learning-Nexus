        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
                <ul class="navbar-nav custom-nav ul-padding ">
                    ...
                    <li class="nav-item custom-nav-item"><a href="logout.php" class="nav-link fw-bolder">Logout</a></li>
                    <?php endif ?>

                    <?php if(!isset($_SESSION['authenticated'])): ?>
                    <li class="nav-item custom-nav-item"><a href="login.php" class="nav-link fw-bolder">Login</a></li>
                    <li class="nav-item custom-nav-item"><a href="register.php" class="nav-link fw-bolder">Signup</a>
                    </li>
                    <?php endif ?>


                    <li class="nav-item custom-nav-item"><a href="#" class="nav-link fw-bolder">Feedback</a></li>
                    <li class="nav-item custom-nav-item"><a href="dashboard.php"
                            class="nav-link fw-bolder">Dashboard</a>
                    </li>
                </ul>
            </div>
        </div>
